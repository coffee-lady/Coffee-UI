...
local Widget = require('CoffeeUI.gui.widget.widget')
local SliderIndicatorView = require('CoffeeUI.gui.components.slider.view.indicators.indicator_view.slider_indicator_view')
