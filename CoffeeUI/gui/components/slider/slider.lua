local ScrollController = require('CoffeeUI.gui.components.slider.controllers.scroll_controller_slider')
local SliderIndicatorsView = require('CoffeeUI.gui.components.slider.view.indicators.slider_indicators_view')
local SliderArrowsView = require('CoffeeUI.gui.components.slider.view.arrows.slider_arrows_view')
local StickyElementView = require('CoffeeUI.gui.components.slider.view.sticky_element.sticky_element_view')
...
function SliderComponent:initialize(event_bus, params, slider_common)
    ...
    self.event_all_items_positions_updated = self.scroll_handler.event_all_items_positions_updated
end
...
function SliderComponent:add_indicators(container_id, indicator_template_id, gap)
    ...
    self.slider_indicators:on_item_picked(
        function(index)
...
function SliderComponent:add_sticky_element(nodes, params)
    ...
    self.scroll_handler:on_item_position_updated(
        function(rel_pos, scroll_index)
    ...
    self.scroll_handler:on_all_items_positions_updated(
        function(first_scroll_index)
