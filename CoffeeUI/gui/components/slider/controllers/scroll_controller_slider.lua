...
local FancyScroll = require('CoffeeUI.gui.fancy_scroll.fancy_scroll')
...
function ScrollController:initialize(params, slider_common)
    ...
    self.event_all_items_positions_updated = self.scroll_view.event_all_items_positions_updated
