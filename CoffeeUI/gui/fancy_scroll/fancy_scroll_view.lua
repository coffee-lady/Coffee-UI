local Scroller = require('CoffeeUI.gui.fancy_scroll.core.scroller')
local CoreScrollView = require('CoffeeUI.gui.fancy_scroll.core.core_scroll_view')
local Scrollbar = require('CoffeeUI.gui.fancy_scroll.scrollbar.scrollbar')
...
function FancyScrollView:on_scroll(callback)
    ...
    self.scroller.event_update_selection:add(
        function(index)
            callback(index)
        end
    )
...
function FancyScrollView:on_input(action_id, action)
    ...
    if self.scroller.scrollbar and self.scroller.scrollbar.on_input then
