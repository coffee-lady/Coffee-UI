local AnimatedThemeNode = require('CoffeeUI.gui.core.theme_objects.AnimatedThemeNode')
...
function ThemeNode:_paint(mode_colors)
    assert(mode_colors, 'no mode_colors for ' .. self.current_mode .. ' ' .. tostring(self.current_submode))
