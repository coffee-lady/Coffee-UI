local GUICore = require('CoffeeUI.gui.core.core')
local UIConfig = require('CoffeeUI.gui.transitions.config.screen_transition_config')
local Transition = require('CoffeeUI.gui.transitions.Transition.Transition')
